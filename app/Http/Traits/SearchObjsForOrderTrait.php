...
trait SearchObjsForOrderTrait
{
    public function SearchObjects($data) {
    ...
    public static function flat($request)
    {
        ...
        $commerces = $flats->whereNotIn('id', $ids)->distinct()->get(['id'])->toArray();
    ...
    public static function commerce($request)
    {
        ...
        $commerces_collect = $commerces->whereNotIn('id', $ids)->distinct()->get(['id'])->toArray();
